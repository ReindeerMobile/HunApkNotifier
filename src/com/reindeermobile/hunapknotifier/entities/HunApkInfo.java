...
public class HunApkInfo {
    ...
    public List<HunApkInfo> getDifferences(List<HunApkInfo> local, List<HunApkInfo> online) {
    ...
    public String toString() {
        return "HunApkInfo [id=" + this.id + ", name=" + this.name + ", date=" + this.date
                + ", link=" + this.link + ", author=" + this.author + "]";
    }
